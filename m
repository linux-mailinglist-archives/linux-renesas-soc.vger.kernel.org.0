...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 607DD423B9E
	for <lists+linux-renesas-soc@lfdr.de>; Wed,  6 Oct 2021 12:41:29 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S237957AbhJFKnU (ORCPT <rfc822;lists+linux-renesas-soc@lfdr.de>);
        Wed, 6 Oct 2021 06:43:20 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:40636 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S237836AbhJFKnU (ORCPT
        <rfc822;linux-renesas-soc@vger.kernel.org>);
        Wed, 6 Oct 2021 06:43:20 -0400
Received: from mail-lf1-x12d.google.com (mail-lf1-x12d.google.com [IPv6:2a00:1450:4864:20::12d])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id CFC68C06174E
        for <linux-renesas-soc@vger.kernel.org>; Wed,  6 Oct 2021 03:41:27 -0700 (PDT)
Received: by mail-lf1-x12d.google.com with SMTP id y15so8497919lfk.7
        for <linux-renesas-soc@vger.kernel.org>; Wed, 06 Oct 2021 03:41:27 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=ragnatech-se.20210112.gappssmtp.com; s=20210112;
        h=date:from:to:cc:subject:message-id:references:mime-version
         :content-disposition:content-transfer-encoding:in-reply-to;
        bh=+Q/lR2IEEtt+bPVrJUh/NWj1Ej9Bj9bQ+ACfaLY3NoM=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=x-gm-message-state:date:from:to:cc:subject:message-id:references
         ...
         :in-reply-to;
        bh=+Q/lR2IEEtt+bPVrJUh/NWj1Ej9Bj9bQ+ACfaLY3NoM=;
        b=
X-Gm-Message-State: AOAM5308q61Ac41GlT9t5r+uM+YXH3YzbLmIUu4zOO/IveZ1zLMRtPGv
        n0AOUIl4N22tUga4JniwPTi+yQ==
X-Google-Smtp-Source: ABdhPJxX50bstFNPv4RLRWIq0ALNNNhAv+7xwhWzBb/ZGg0bjP8vfGLy/DeXP9Wc+QinYPC227pDbw==
X-Received: by 2002:a2e:b8cd:: with SMTP id s13mr27881844ljp.44.1633516885849;
        Wed, 06 Oct 2021 03:41:25 -0700 (PDT)
Received: from localhost (h-46-59-88-219.A463.priv.bahnhof.se. [46.59.88.219])
        by smtp.gmail.com with ESMTPSA id s25sm2165447ljc.100.2021.10.06.03.41.24
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Wed, 06 Oct 2021 03:41:25 -0700 (PDT)
Date:   Wed, 6 Oct 2021 12:41:24 +0200
...
Subject: Re: [PATCH v5] media: rcar-isp: Add Renesas R-Car Image Signal
 Processor driver
Message-ID: <YV19VGsfrZRzb0QJ@oden.dyn.berto.se>
References: <20210914140057.2801405-1-niklas.soderlund+renesas@ragnatech.se>
 <20211004102159.y7bgaejz4ez47p3p@uno.localdomain>
 <YVyfyRKXA3/pnZdU@oden.dyn.berto.se>
 <20211006091122.la2fjos4tnyfken4@uno.localdomain>
MIME-Version: 1.0
Content-Type: text/plain; charset=iso-8859-1
Content-Disposition: inline
Content-Transfer-Encoding: 8bit
In-Reply-To: <20211006091122.la2fjos4tnyfken4@uno.localdomain>
Precedence: bulk
...
On 2021-10-06 11:11:22 +0200, Jacopo Mondi wrote:
> Hi Niklas,
> 
...
I understood this, the issue I was refering to is that the callbacks 
from SIMPLE_DEV_PM_OPS in this design would race with the callbacks from 
rcar-vin SIMPLE_DEV_PM_OPS if there is an active stream when the system 
is suspended/resumed.

If two drivers in the pipeline implement SIMPLE_DEV_PM_OPS operations 
like you suggest here what happens when the system resumes? Right now if 
there was an active stream rcar-vin will issue a s_stream(1) call in 
it's resume callback. This then races with the design here as the 
s_stream(1) call might have completed before or during these callbacks 
are running, resetting the ISP unexpectedly.

It is less likely for IP blocks and I think I opted for this design when 
I added suspend/resume support for R-Car VIN after fighting with ADV7482 
I2C interface when resuming. I'm sure we can improve here but right now 
this is the way to go IMHO. We can look at the whole suspend/resume 
problem on top as it concerns mostly the interactions between drivers in 
a generic pipeline and is not specific to this driver.
