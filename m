...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 3F1427DF5AE
	for <lists+linux-renesas-soc@lfdr.de>; Thu,  2 Nov 2023 16:07:58 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229537AbjKBPH6 (ORCPT <rfc822;lists+linux-renesas-soc@lfdr.de>);
        Thu, 2 Nov 2023 11:07:58 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:35242 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229489AbjKBPH5 (ORCPT
        <rfc822;linux-renesas-soc@vger.kernel.org>);
        Thu, 2 Nov 2023 11:07:57 -0400
Received: from relmlie6.idc.renesas.com (relmlor2.renesas.com [210.160.252.172])
        by lindbergh.monkeyblade.net (Postfix) with ESMTP id 3D479186
        for <linux-renesas-soc@vger.kernel.org>; Thu,  2 Nov 2023 08:07:53 -0700 (PDT)
X-IronPort-AV: E=Sophos;i="6.03,271,1694703600"; 
   d="scan'208";a="185401171"
Received: from unknown (HELO relmlir6.idc.renesas.com) ([10.200.68.152])
  by relmlie6.idc.renesas.com with ESMTP; 03 Nov 2023 00:07:52 +0900
Received: from localhost.localdomain (unknown [10.226.92.132])
        by relmlir6.idc.renesas.com (Postfix) with ESMTP id 3637E439497C;
        Fri,  3 Nov 2023 00:07:46 +0900 (JST)
...
Subject: [PATCH v12 0/4] Add RZ/{G2L,G2LC} and RZ/V2L Display Unit support
Date:   Thu,  2 Nov 2023 15:07:40 +0000
Message-Id: <20231102150744.28736-1-biju.das.jz@bp.renesas.com>
...
00000 400000000 500000000   time(ms)
 ...
 [INFO]   125000000:         0         0         0         0         0     =
    0         0         0         0
 [INFO]   200000000:         0         0         0         0         0     =
    0         0        80      4568
 [INFO] * 250000000:         0         0         0         0        65     =
    0         0         0      5372
 [INFO]   400000000:         1         0         0         0         1     =
    0         0         3       328
 [INFO]   500000000:         1         0         0         0        14     =
   66         5         0      5316
 [INFO] Total transition : 238
...
Biju Das (4):
 ...
 16 files changed, 2093 insertions(+), 2 deletions(-)
