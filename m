...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id BB6EA51AD79
	for <lists+linux-renesas-soc@lfdr.de>; Wed,  4 May 2022 21:06:31 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1377464AbiEDTKG (ORCPT <rfc822;lists+linux-renesas-soc@lfdr.de>);
        Wed, 4 May 2022 15:10:06 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:37506 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1377472AbiEDTKF (ORCPT
        <rfc822;linux-renesas-soc@vger.kernel.org>);
        Wed, 4 May 2022 15:10:05 -0400
Received: from relmlie5.idc.renesas.com (relmlor1.renesas.com [210.160.252.171])
        by lindbergh.monkeyblade.net (Postfix) with ESMTP id CA66D3BA68;
        Wed,  4 May 2022 12:06:28 -0700 (PDT)
X-IronPort-AV: E=Sophos;i="5.91,198,1647270000"; 
   d="scan'208";a="118725638"
Received: from unknown (HELO relmlir6.idc.renesas.com) ([10.200.68.152])
  by relmlie5.idc.renesas.com with ESMTP; 05 May 2022 04:06:28 +0900
Received: from localhost.localdomain (unknown [10.226.92.27])
        by relmlir6.idc.renesas.com (Postfix) with ESMTP id 2966540D954D;
        Thu,  5 May 2022 04:06:24 +0900 (JST)
...
Subject: [PATCH v10 3/5] media: renesas: vsp1: Add support for VSP software version
Date:   Wed,  4 May 2022 20:06:07 +0100
Message-Id: <20220504190609.94375-4-biju.das.jz@bp.renesas.com>
...
index 2a18cd6ec538..f9394d858fef 100644
--- a/drivers/media/platform/renesas/vsp1/vsp1_drv.c
+++ b/drivers/media/platform/renesas/vsp1/vsp1_drv.c
@@ -808,11 +808,39 @@ static const struct vsp1_device_info vsp1_device_infos[] = {
 	},
 };
...
@@ -868,19 +896,8 @@ static int vsp1_probe(struct platform_device *pdev)
 	if (ret < 0)
 		goto done;
