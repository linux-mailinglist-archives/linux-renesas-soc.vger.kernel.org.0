...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 6BB3E46618A
	for <lists+linux-renesas-soc@lfdr.de>; Thu,  2 Dec 2021 11:35:02 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1345725AbhLBKiX (ORCPT <rfc822;lists+linux-renesas-soc@lfdr.de>);
        Thu, 2 Dec 2021 05:38:23 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:39084 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233849AbhLBKiX (ORCPT
        <rfc822;linux-renesas-soc@vger.kernel.org>);
        Thu, 2 Dec 2021 05:38:23 -0500
Received: from perceval.ideasonboard.com (perceval.ideasonboard.com [IPv6:2001:4b98:dc2:55:216:3eff:fef7:d647])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id B6C73C06174A
        for <linux-renesas-soc@vger.kernel.org>; Thu,  2 Dec 2021 02:35:00 -0800 (PST)
Received: from pendragon.ideasonboard.com (cpc89244-aztw30-2-0-cust3082.18-1.cable.virginm.net [86.31.172.11])
        by perceval.ideasonboard.com (Postfix) with ESMTPSA id 9B594D8C;
        Thu,  2 Dec 2021 11:34:58 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=ideasonboard.com;
        s=mail; t=1638441298;
        bh=M9cPAdxpd/GBiggBzkewREPJEyHnUaxp5UQFkg3PIb4=;
        h=In-Reply-To:References:Subject:From:Cc:To:Date:From;
        b=DiFMK5+CQdzHEPKE7SDZ90toLqIWadtmOz8udKxc0U7UNyhSniiIwCAqkRWZIbABK
         49TSuqaod1n3o83K0stIdmFb0AxUR3thzBTHDQELUQWtVFKgYQfPWiE5qe8y2Bhaj4
         T8IWNfosbU970JtuXZtjFmCdpMw/XUGuA2Z6Db6U=
...
Date:   Thu, 02 Dec 2021 10:34:56 +0000
Message-ID: <163844129641.3059017.9742490265453712282@Monstersaurus>
...
(Re-Re-Re)Tested-by: Kieran Bingham <kieran.bingham+renesas@ideasonboard.co=
m>
...
> index 000000000000..faf993eae564
> --- /dev/null
...
tc;
> +       mode =3D &drm_atomic_get_new_crtc_state(state, crtc)->adjusted_mo=
de;
> +
...
> +       }
> +
> +       ret =3D rcar_mipi_dsi_startup(dsi, mode);
> +       if (ret < 0)
...
> +       .atomic_enable =3D rcar_mipi_dsi_atomic_enable,
> +       .atomic_disable =3D rcar_mipi_dsi_atomic_disable,
