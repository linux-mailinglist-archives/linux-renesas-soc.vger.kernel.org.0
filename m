Return-Path: <linux-renesas-soc+bounces-86-lists+linux-renesas-soc=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-renesas-soc@lfdr.de
Delivered-To: lists+linux-renesas-soc@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 1B6D37F3CE9
	for <lists+linux-renesas-soc@lfdr.de>; Wed, 22 Nov 2023 05:31:33 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id C0CF2281A49
	for <lists+linux-renesas-soc@lfdr.de>; Wed, 22 Nov 2023 04:31:31 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 2E001C2C2;
	Wed, 22 Nov 2023 04:31:02 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=ideasonboard.com header.i=@ideasonboard.com header.b="mpmeS+s3"
X-Original-To: linux-renesas-soc@vger.kernel.org
Received: from perceval.ideasonboard.com (perceval.ideasonboard.com [IPv6:2001:4b98:dc2:55:216:3eff:fef7:d647])
	by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 943261BB;
	Tue, 21 Nov 2023 20:30:39 -0800 (PST)
Received: from pendragon.ideasonboard.com (213-243-189-158.bb.dnainternet.fi [213.243.189.158])
	by perceval.ideasonboard.com (Postfix) with ESMTPSA id 0470EDB7;
	Wed, 22 Nov 2023 05:29:56 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=ideasonboard.com;
	s=mail; t=1700627397;
	bh=otUf39EqGIIXTw3uaXUnUm2hwuNsNytciW1rbn4qjJU=;
	h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
	b=mpmeS+s31lnH2mYQEzERkxOVC7tYKpstlXRIZVvZVVOnPGxNQqONyDS7aBQtabpKK
	 Dqy2VvnEg48c5lFBMq5hFt+2GJqW9pCRr+J/j1kdWyG12A2OVTgghb6o6PyERWbL7Y
	 wHe9stsnm80h++RztUmDvMY84dvIvII07Mr4C7r0=
...
Subject: [RFC PATCH v1 18/19] media: renesas: vsp1: Switch to V4L2 subdev active state
Date: Wed, 22 Nov 2023 06:30:08 +0200
Message-ID: <20231122043009.2741-19-laurent.pinchart+renesas@ideasonboard.com>
...
index 7639ea53dd47..435c317ad05e 100644
...
index 56c77809d2ec..4aa52b71e857 100644
...
index d3533a75361a..5f9a67f6df68 100644
...
index 1d9d050e79da..8c150c41a623 100644
...
index 21cffe6947a2..3d3b7da9f8ec 100644
...
index a447ed1c59c3..2968aae7ba82 100644
...
index a4076d82651e..ec3ca0b7916c 100644
--- a/drivers/media/platform/renesas/vsp1/vsp1_histo.c
+++ b/drivers/media/platform/renesas/vsp1/vsp1_histo.c
@@ -199,26 +199,15 @@ static int histo_enum_frame_size(struct v4l2_subdev *subdev,
 }
...
@@ -247,13 +236,10 @@ static int histo_get_selection(struct v4l2_subdev *subdev,
 		break;
...
@@ -326,34 +312,18 @@ static int histo_set_compose(struct v4l2_subdev *subdev,
 }
...
@@ -381,7 +351,7 @@ static int histo_set_format(struct v4l2_subdev *subdev,
...
index 932ac1c795bc..c41691c2bf71 100644
...
index 308917338022..edbc634a378c 100644
...
index 0382ddaa6911..7abe5aa5de28 100644
...
index 37f89fa5a6e2..2b36fdc5f77e 100644
...
index 309f02b49088..32b3710d0985 100644
...
index 4f32024b9ed4..0c324623699a 100644
...
index d39a89a0f27d..ddf624f30b92 100644
...
index e69acb5f0fbb..4361be5d91c4 100644
...
index 6645cf1d533b..ee830164c783 100644
--- a/drivers/media/platform/renesas/vsp1/vsp1_video.c
+++ b/drivers/media/platform/renesas/vsp1/vsp1_video.c
@@ -670,6 +670,7 @@ static int vsp1_video_pipeline_setup_partitions(struct vsp1_pipeline *pipe)
 {
...
+	struct v4l2_subdev_state *state;
 	...
 	unsigned int i;
@@ -678,8 +679,8 @@ static int vsp1_video_pipeline_setup_partitions(struct vsp1_pipeline *pipe)
 	 * Partitions are computed on the size before rotation, use the format
 	 * at the WPF sink.
 	 */
-	format = v4l2_subdev_state_get_format(pipe->output->entity.state,
...
+	format = v4l2_subdev_state_get_format(state, RWPF_PAD_SINK);
 	...
 	/*
@@ -693,9 +694,8 @@ static int vsp1_video_pipeline_setup_partitions(struct vsp1_pipeline *pipe)
...
@@ -755,8 +755,11 @@ static int vsp1_video_setup_pipeline(struct vsp1_pipeline *pipe)
 		return -ENOMEM;
...
index e3d961c8d3e3..6ba0d57de890 100644
