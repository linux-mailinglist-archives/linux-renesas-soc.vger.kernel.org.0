Return-Path: <linux-renesas-soc+bounces-13700-lists+linux-renesas-soc=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-renesas-soc@lfdr.de
Delivered-To: lists+linux-renesas-soc@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 75B20A46058
	for <lists+linux-renesas-soc@lfdr.de>; Wed, 26 Feb 2025 14:11:04 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 6472C3AFED8
	for <lists+linux-renesas-soc@lfdr.de>; Wed, 26 Feb 2025 13:10:40 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id D662821E097;
	Wed, 26 Feb 2025 13:10:18 +0000 (UTC)
X-Original-To: linux-renesas-soc@vger.kernel.org
Received: from relmlie6.idc.renesas.com (relmlor2.renesas.com [210.160.252.172])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id C58BC21C9FA;
	Wed, 26 Feb 2025 13:10:15 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=210.160.252.172
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1740575418; cv=none; b=kr488yG/XFL6UJr5MyfRZqczbqJP/i81ZiObOfUU5ahv7hhqBqVcoKJJuAF+dnXxQgvGjcUo3SkB2l0WGOZTmR+isaQEuZYP6a/xj/yI4QSiDjcCJc3nllBjYll0J8CtFD8t/tdt9W6tBcsE36qHkAk21T6Ioz1+qxZFSZSr/h8=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1740575418; c=relaxed/simple;
	bh=ZMUtiqSp6o5q67wrgU2JcQLm9jipb0HIEaYZwI4duDc=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=BPuwfU5oCFeQ5Rkimeth1tu+fB+x+Cf0B7qFctY/C4hswTheueBIfm0vdkDzsuruZPgOjm7qGRTmGOzNddeKZwxwZGN+JpwJrUZqKw5hRAzhO+Za0Urv6J2ss0ZTfHtj2s8nxFkY2h7Md2xSMibfDdhyCikaDBmXOiHiKuROs4A=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=bp.renesas.com; spf=pass smtp.mailfrom=bp.renesas.com; arc=none smtp.client-ip=210.160.252.172
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=bp.renesas.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=bp.renesas.com
X-CSE-ConnectionGUID: HjJsip/YTiaozQ54oF5PCw==
X-CSE-MsgGUID: 5Qy6223fQXi5rmXxDe+olQ==
Received: from unknown (HELO relmlir5.idc.renesas.com) ([10.200.68.151])
  by relmlie6.idc.renesas.com with ESMTP; 26 Feb 2025 22:10:14 +0900
Received: from superbuilder.administration.lan (unknown [10.226.92.221])
	by relmlir5.idc.renesas.com (Postfix) with ESMTP id E93DC4069605;
	Wed, 26 Feb 2025 22:10:11 +0900 (JST)
...
Subject: [PATCH v3 06/13] clk: renesas: Add support for R9A09G077 SoC
Date: Wed, 26 Feb 2025 14:09:25 +0100
Message-ID: <20250226130935.3029927-7-thierry.bultel.yh@bp.renesas.com>
...
index 000000000000..91521b1fc62e
--- /dev/null
...
index b78992217e58..397a301f7656 100644
...
@@ -1070,6 +1113,13 @@ static int __init cpg_mssr_common_init(struct device *dev,
 		error = -ENOMEM;
 		goto out_err;
 	}
...
@@ -1083,6 +1133,8 @@ static int __init cpg_mssr_common_init(struct device *dev,
...
@@ -1113,6 +1165,8 @@ static int __init cpg_mssr_common_init(struct device *dev,
 out_err:
 	if (priv->pub.base0)
