...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 7A27A51AD7B
	for <lists+linux-renesas-soc@lfdr.de>; Wed,  4 May 2022 21:06:35 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1377471AbiEDTKK (ORCPT <rfc822;lists+linux-renesas-soc@lfdr.de>);
        Wed, 4 May 2022 15:10:10 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:37576 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1377475AbiEDTKJ (ORCPT
        <rfc822;linux-renesas-soc@vger.kernel.org>);
        Wed, 4 May 2022 15:10:09 -0400
Received: from relmlie5.idc.renesas.com (relmlor1.renesas.com [210.160.252.171])
        by lindbergh.monkeyblade.net (Postfix) with ESMTP id 1263839813;
        Wed,  4 May 2022 12:06:31 -0700 (PDT)
X-IronPort-AV: E=Sophos;i="5.91,198,1647270000"; 
   d="scan'208";a="118725647"
Received: from unknown (HELO relmlir6.idc.renesas.com) ([10.200.68.152])
  by relmlie5.idc.renesas.com with ESMTP; 05 May 2022 04:06:31 +0900
Received: from localhost.localdomain (unknown [10.226.92.27])
        by relmlir6.idc.renesas.com (Postfix) with ESMTP id C1B0940D9551;
        Thu,  5 May 2022 04:06:28 +0900 (JST)
...
Subject: [PATCH v10 4/5] media: renesas: vsp1: Add VSP1_HAS_NON_ZERO_LBA feature bit
Date:   Wed,  4 May 2022 20:06:08 +0100
Message-Id: <20220504190609.94375-5-biju.das.jz@bp.renesas.com>
...
index f9394d858fef..102a5dbfa246 100644
--- a/drivers/media/platform/renesas/vsp1/vsp1_drv.c
+++ b/drivers/media/platform/renesas/vsp1/vsp1_drv.c
@@ -778,6 +778,7 @@ static const struct vsp1_device_info vsp1_device_infos[] = {
 	}, {
...
+		.soc = VI6_IP_VERSION_SOC_V3H,
 		...
 		.lif_count = 1,
@@ -785,6 +786,17 @@ static const struct vsp1_device_info vsp1_device_infos[] = {
 		.uif_count = 1,
 		.wpf_count = 1,
 		.num_bru_inputs = 5,
+	}, {
...
+		.num_bru_inputs = 5,
 		...
 		.model = "VSP2-DL",
@@ -828,8 +840,12 @@ static const struct vsp1_device_info *vsp1_lookup_info(struct vsp1_device *vsp1)
