...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id E11414D5FDD
	for <lists+linux-renesas-soc@lfdr.de>; Fri, 11 Mar 2022 11:38:41 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1348070AbiCKKj2 (ORCPT <rfc822;lists+linux-renesas-soc@lfdr.de>);
        Fri, 11 Mar 2022 05:39:28 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:47246 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1347920AbiCKKjV (ORCPT
        <rfc822;linux-renesas-soc@vger.kernel.org>);
        Fri, 11 Mar 2022 05:39:21 -0500
Received: from relmlie6.idc.renesas.com (relmlor2.renesas.com [210.160.252.172])
        by lindbergh.monkeyblade.net (Postfix) with ESMTP id E033812D917;
        Fri, 11 Mar 2022 02:38:17 -0800 (PST)
X-IronPort-AV: E=Sophos;i="5.90,173,1643641200"; 
   d="scan'208";a="114094186"
Received: from unknown (HELO relmlir5.idc.renesas.com) ([10.200.68.151])
  by relmlie6.idc.renesas.com with ESMTP; 11 Mar 2022 19:38:17 +0900
Received: from localhost.localdomain (unknown [10.226.93.53])
        by relmlir5.idc.renesas.com (Postfix) with ESMTP id 445B640062CC;
        Fri, 11 Mar 2022 19:38:15 +0900 (JST)
...
Subject: [PATCH v3 3/3] media: vsp1: Add support for RZ/G2L VSPD
Date:   Fri, 11 Mar 2022 10:38:03 +0000
Message-Id: <20220311103803.25239-4-biju.das.jz@bp.renesas.com>
...
index 2b1a6ada9fff..a2a737a4fedc 100644
--- a/drivers/media/platform/vsp1/vsp1_drv.c
+++ b/drivers/media/platform/vsp1/vsp1_drv.c
@@ -807,11 +807,37 @@ static const struct vsp1_device_info vsp1_device_infos[] = {
 	},
 };
...
@@ -867,24 +893,21 @@ static int vsp1_probe(struct platform_device *pdev)
 	if (ret < 0)
 		goto done;
...
+	vsp1->version = vsp1->info->version;
 	...
 	/*
@@ -936,6 +959,7 @@ static int vsp1_remove(struct platform_device *pdev)
