...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 8DE2657E73E
	for <lists+linux-renesas-soc@lfdr.de>; Fri, 22 Jul 2022 21:19:46 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233512AbiGVTTq (ORCPT <rfc822;lists+linux-renesas-soc@lfdr.de>);
        Fri, 22 Jul 2022 15:19:46 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:53740 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S236047AbiGVTTp (ORCPT
        <rfc822;linux-renesas-soc@vger.kernel.org>);
        Fri, 22 Jul 2022 15:19:45 -0400
Received: from relmlie6.idc.renesas.com (relmlor2.renesas.com [210.160.252.172])
        by lindbergh.monkeyblade.net (Postfix) with ESMTP id 90A4697D43
        for <linux-renesas-soc@vger.kernel.org>; Fri, 22 Jul 2022 12:19:42 -0700 (PDT)
X-IronPort-AV: E=Sophos;i="5.93,186,1654527600"; 
   d="scan'208";a="128811342"
Received: from unknown (HELO relmlir5.idc.renesas.com) ([10.200.68.151])
  by relmlie6.idc.renesas.com with ESMTP; 23 Jul 2022 04:19:41 +0900
Received: from localhost.localdomain (unknown [10.226.92.254])
        by relmlir5.idc.renesas.com (Postfix) with ESMTP id E2A7E4000A89;
        Sat, 23 Jul 2022 04:19:37 +0900 (JST)
...
Subject: [PATCH v4 2/2] drm: rcar-du: Add RZ/G2L DSI driver
Date:   Fri, 22 Jul 2022 20:19:24 +0100
Message-Id: <20220722191924.544869-3-biju.das.jz@bp.renesas.com>
...
index 000000000000..e81b7a64ea10
--- /dev/null
...
+	if (!ep) {
+		dev_err(dsi->dev, "unconnected port@1\n");
+		return -ENODEV;
+	}
+
