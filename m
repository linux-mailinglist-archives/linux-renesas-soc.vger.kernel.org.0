...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 8AA3C57E71D
	for <lists+linux-renesas-soc@lfdr.de>; Fri, 22 Jul 2022 21:14:16 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233633AbiGVTOP (ORCPT <rfc822;lists+linux-renesas-soc@lfdr.de>);
        Fri, 22 Jul 2022 15:14:15 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:49750 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S235282AbiGVTOO (ORCPT
        <rfc822;linux-renesas-soc@vger.kernel.org>);
        Fri, 22 Jul 2022 15:14:14 -0400
Received: from relmlie6.idc.renesas.com (relmlor2.renesas.com [210.160.252.172])
        by lindbergh.monkeyblade.net (Postfix) with ESMTP id 49FFCA6F9F
        for <linux-renesas-soc@vger.kernel.org>; Fri, 22 Jul 2022 12:14:10 -0700 (PDT)
X-IronPort-AV: E=Sophos;i="5.93,186,1654527600"; 
   d="scan'208";a="128811028"
Received: from unknown (HELO relmlir5.idc.renesas.com) ([10.200.68.151])
  by relmlie6.idc.renesas.com with ESMTP; 23 Jul 2022 04:14:10 +0900
Received: from localhost.localdomain (unknown [10.226.92.254])
        by relmlir5.idc.renesas.com (Postfix) with ESMTP id DF1D640078DB;
        Sat, 23 Jul 2022 04:14:05 +0900 (JST)
...
Subject: [PATCH v4 2/2] drm: rcar-du: Add RZ/G2L DU Support
Date:   Fri, 22 Jul 2022 20:13:53 +0100
Message-Id: <20220722191353.544516-3-biju.das.jz@bp.renesas.com>
...
index 000000000000..b2f65d01a2ae
--- /dev/null
...
+	struct rzg2l_du_device *rcdu = rcrtc->dev;
+
+	rzg2l_du_write(rcdu, DU_MCR0, start ? DU_MCR0_DI_EN : 0);
+}
+
...
new file mode 100644
index 000000000000..6a1e16f027ac
--- /dev/null
...
new file mode 100644
index 000000000000..f7d455768194
--- /dev/null
...
new file mode 100644
index 000000000000..6e73e70d45de
--- /dev/null
...
new file mode 100644
index 000000000000..a572e3bdf34a
--- /dev/null
...
new file mode 100644
index 000000000000..34419f1c7f57
--- /dev/null
...
new file mode 100644
index 000000000000..75d2d6ffc654
--- /dev/null
...
new file mode 100644
index 000000000000..ce20688f0902
--- /dev/null
...
new file mode 100644
index 000000000000..07787c12d5b6
--- /dev/null
...
new file mode 100644
index 000000000000..810b4aaba9ec
--- /dev/null
...
new file mode 100644
index 000000000000..be16f1b9d39f
--- /dev/null
...
new file mode 100644
index 000000000000..4cb3a9bbbed5
--- /dev/null
+++ b/drivers/gpu/drm/rcar-du/rzg2l_du_writeback.c
@@ -0,0 +1,250 @@
+// SPDX-License-Identifier: GPL-2.0
+/*
+ * RZ/G2L Display Unit Writeback Support
+ *
...
new file mode 100644
index 000000000000..f92294cdc354
--- /dev/null
