...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 3DB935A5058
	for <lists+linux-renesas-soc@lfdr.de>; Mon, 29 Aug 2022 17:40:53 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229607AbiH2Pkv (ORCPT <rfc822;lists+linux-renesas-soc@lfdr.de>);
        Mon, 29 Aug 2022 11:40:51 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:41650 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229588AbiH2Pkt (ORCPT
        <rfc822;linux-renesas-soc@vger.kernel.org>);
        Mon, 29 Aug 2022 11:40:49 -0400
Received: from mail-ej1-x633.google.com (mail-ej1-x633.google.com [IPv6:2a00:1450:4864:20::633])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id CF66786063
        for <linux-renesas-soc@vger.kernel.org>; Mon, 29 Aug 2022 08:40:46 -0700 (PDT)
Received: by mail-ej1-x633.google.com with SMTP id cu2so16579632ejb.0
        for <linux-renesas-soc@vger.kernel.org>; Mon, 29 Aug 2022 08:40:46 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=linaro.org; s=google;
        h=cc:to:subject:message-id:date:from:in-reply-to:references
         :mime-version:from:to:cc;
        bh=Uofo+XhbbxTnvHmQ3/zGg9rNC6Rj9BKI8S6htWMsSKA=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=Uofo+XhbbxTnvHmQ3/zGg9rNC6Rj9BKI8S6htWMsSKA=;
        b=
X-Gm-Message-State: ACgBeo3OjugiwwjOvIxDTpWjuyuuHoqj6+bDc2bFr4JVG6LkKRAAo4db
        xROWdNuqXCz3dsfXA374ZL74/0fDIQtsqLwXtW2+jd06Hwg=
X-Google-Smtp-Source: AA6agR4GoS9gCFE1TQleiUqSh+0KJ4w1witYcAQptzPC+T25EAE3hf04MaAOZEMvlsVG8hZKAkKK68gH5jWr0os19DQ=
X-Received: by 2002:a17:907:9814:b0:73d:cb9f:c0b8 with SMTP id
 ji20-20020a170907981400b0073dcb9fc0b8mr14221261ejc.648.1661787645125; Mon, 29
 Aug 2022 08:40:45 -0700 (PDT)
MIME-Version: 1.0
References: <20220829091901.641784-1-biju.das.jz@bp.renesas.com> <20220829091901.641784-3-biju.das.jz@bp.renesas.com>
In-Reply-To: <20220829091901.641784-3-biju.das.jz@bp.renesas.com>
From:   Robert Foss <robert.foss@linaro.org>
Date:   Mon, 29 Aug 2022 17:40:33 +0200
Message-ID: <CAG3jFys4fKWBGBLX9CNB3xvz4ztgv4vdaTjB-sgrCMy6Zc9Yag@mail.gmail.com>
...
On Mon, 29 Aug 2022 at 11:19, Biju Das <biju.das.jz@bp.renesas.com> wrote:
>
...
> +       int ret;
> +
> +       if (dsi->max_lanes < dsi->lanes || device->lanes > dsi->num_data_lanes) {
...
> +               return ret;
> +
> +       dsi->max_lanes = ((rzg2l_mipi_dsi_link_read(dsi, TXSETR) >> 16) & 0x3) + 1;
> +       pm_runtime_put(dsi->dev);
> +
