...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 188C62DFE70
	for <lists+linux-renesas-soc@lfdr.de>; Mon, 21 Dec 2020 17:59:03 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726200AbgLUQ6u (ORCPT <rfc822;lists+linux-renesas-soc@lfdr.de>);
        Mon, 21 Dec 2020 11:58:50 -0500
Received: from mo4-p02-ob.smtp.rzone.de ([85.215.255.84]:27717 "EHLO
        mo4-p02-ob.smtp.rzone.de" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726130AbgLUQ6u (ORCPT
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; t=1608569752;
        ...
        Subject:Sender;
        bh=w+6EYHvZKc6n6aFG1FbRWM4v5aPXMcKpeF2QGnzvWnU=;
        b=
X-RZG-AUTH: ":OWANVUa4dPFUgKR/3dpvnYP0Np73dmm4I5W0/AvA67Ot4fvR8GJSdzTYQw=="
X-RZG-CLASS-ID: mo00
Received: from groucho.site
        by smtp.strato.de (RZmta 47.10.2 DYNA|AUTH)
        with ESMTPSA id j05b20wBLGtl0KP
...
Subject: [PATCH v2 02/12] pinctrl: renesas: r8a779a0: Add EtherAVB pins, groups and functions
Date:   Mon, 21 Dec 2020 17:55:31 +0100
Message-Id: <20201221165541.27679-3-uli+renesas@fpond.eu>
