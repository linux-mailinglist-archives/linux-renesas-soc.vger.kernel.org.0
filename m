Return-Path: <linux-renesas-soc+bounces-1875-lists+linux-renesas-soc=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-renesas-soc@lfdr.de
Delivered-To: lists+linux-renesas-soc@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 3B09183D8B7
	for <lists+linux-renesas-soc@lfdr.de>; Fri, 26 Jan 2024 11:57:31 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id A3CD41F23D72
	for <lists+linux-renesas-soc@lfdr.de>; Fri, 26 Jan 2024 10:57:29 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 7EFD812E4E;
	Fri, 26 Jan 2024 10:56:59 +0000 (UTC)
X-Original-To: linux-renesas-soc@vger.kernel.org
Received: from baptiste.telenet-ops.be (baptiste.telenet-ops.be [195.130.132.51])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id AB02914273
	for <linux-renesas-soc@vger.kernel.org>; Fri, 26 Jan 2024 10:56:50 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=195.130.132.51
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1706266619; cv=none; b=bbyqcZMkdu2tld5wLbxWB40oz7qonWaY3mtNOoN34P7dwJWz1sil1O5I3Y/6yeUFU9bwakjFOFbvinN/fnDi6uoAEgl+56dwHSGidY6Z+/0GLLsSAOgUNDU9LgknRjVbGz1K42/dRyoZhNHcQwNdzWEWG0gNGn83mg03mcKMZ74=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1706266619; c=relaxed/simple;
	bh=jMsSlGtIQwIcN06h8Bs/gwcZ/EN9f8ZIHpUHQiar/M0=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version; b=RPK5MtXUZo0jXv1hC1fwrpdYFaEgfibKWqCWg0HXYMMdWSupYJdAPB+MkfVeLb6Y863CizXThGqD2A1+mbIKZXh3I27QIb2UENgPgVKW4A73xOF1jjZ7rBqBhk9nk9F2mSrXLLpzRUii6gOLWm5YUtk+UnECmi18t0LlKrZmajA=
...
Received: from ramsan.of.borg ([IPv6:2a02:1810:ac12:ed40:8d64:ae04:ce87:de06])
	...
	id fNwo2B00D1AdMdB01Nwokm; Fri, 26 Jan 2024 11:56:48 +0100
...
Subject: [PATCH 02/14] pinctrl: renesas: Initial R8A779H0 (R-Car V4M) PFC support
Date: Fri, 26 Jan 2024 11:44:00 +0100
Message-Id: <5f59263e75be713dc954007cfeb2c99274c9d761.1706264667.git.geert+renesas@glider.be>
...
Changes compared to the BSP:
  ...
  - s/R8A779A0/R8A779H0/,
  - s/Copyright (C) 2021/Copyright (C) 2023/,
  - Use TABs instead of spaces for alignment in Makefile,
  - Fix issues flagged by sh_pfc checker (CONFIG_DEBUG_PINCTRL=y):
      - Remove non-existent GP2_16 and GP2_18,
      - s/IP2SR4_27_24/IP2SR4_23_20/ in GPSR4_21 definition,
      - Remove empty IP2SR2_* and IP2SR4_* definitions,
      - Fix GPSR2/IP3SR1/IP3SR4/IP2SR5 variable-width description,
      - Use more variable-width reserved field descriptions,
      - s/IP2SR3/IP3SR3/ in IP3SR3 config register description,
      - Fix TCLK4/TCLK3 in DRV3CTRL3 config register description,
      - Fix GP1_23-28 and GP4_13 POC descriptions.
  - Remove unneeded TABs in macros to reduce line width,
  - Change IP1SR5 to IP2SR5 in comment,
  - Change FXR_TXENA_N_A to FXR_TXENA_N_B,
  - Add missing "_A" suffix to FXR_TXEN[AB]_N,
  - Add missing PINMUX_IPSR_GPSR() for ERROROUTC_N_A, TX4, and RX4,
  - Add missing Ether_GPTP_PPS1.
---
 drivers/pinctrl/renesas/Kconfig        |    5 +
 drivers/pinctrl/renesas/Makefile       |    1 +
 drivers/pinctrl/renesas/core.c         |    6 +
 drivers/pinctrl/renesas/pfc-r8a779h0.c | 2321 ++++++++++++++++++++++++
 drivers/pinctrl/renesas/sh_pfc.h       |    1 +
 5 files changed, 2334 insertions(+)
 create mode 100644 drivers/pinctrl/renesas/pfc-r8a779h0.c

diff --git a/drivers/pinctrl/renesas/Kconfig b/drivers/pinctrl/renesas/Kconfig
index c8d519ca53eb7f31..d03725c8d09894bf 100644
...
index 3e776955bd4bc776..2ba623e04bf8c755 100644
...
index 8f6d7cc25b599149..78331d7f7cca9d8c 100644
...
index 0000000000000000..0635a52828676c37
--- /dev/null
...
index 8dc7a66009ad842c..0061e96400598e49 100644
