Return-Path: <linux-renesas-soc+bounces-30474-lists+linux-renesas-soc=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-renesas-soc@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id mH2LIszVxmmtPAUAu9opvQ
	(envelope-from <linux-renesas-soc+bounces-30474-lists+linux-renesas-soc=lfdr.de@vger.kernel.org>)
	for <lists+linux-renesas-soc@lfdr.de>; Fri, 27 Mar 2026 20:09:00 +0100
X-Original-To: lists+linux-renesas-soc@lfdr.de
Received: from tor.lore.kernel.org (tor.lore.kernel.org [IPv6:2600:3c04:e001:36c::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id F37D7349DC3
	for <lists+linux-renesas-soc@lfdr.de>; Fri, 27 Mar 2026 20:08:59 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by tor.lore.kernel.org (Postfix) with ESMTP id 7EA9E31947B4
	for <lists+linux-renesas-soc@lfdr.de>; Fri, 27 Mar 2026 18:56:36 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 3A691413251;
...
X-Spamd-Result: default: False [2.84 / 15.00];
	...
	MIME_TRACE(0.00)[0:+];
	TAGGED_FROM(0.00)[bounces-30474-lists,linux-renesas-soc=lfdr.de];
	...
	TAGGED_RCPT(0.00)[linux-renesas-soc,renesas,netdev,kernel];
	NEURAL_HAM(-0.00)[-1.000];
	ASN(0.00)[asn:63949, ipnet:2600:3c04::/32, country:SG];
	DBL_BLOCKED_OPENRESOLVER(0.00)[nxp.com:dkim,nxp.com:email,nxp.com:mid,glider.be:email,tor.lore.kernel.org:helo,tor.lore.kernel.org:rdns,renesas.com:email,lunn.ch:email,davemloft.net:email,armlinux.org.uk:email]
X-Rspamd-Queue-Id: F37D7349DC3
