...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id DEDFF518AF7
	for <lists+linux-renesas-soc@lfdr.de>; Tue,  3 May 2022 19:22:57 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S240033AbiECR03 (ORCPT <rfc822;lists+linux-renesas-soc@lfdr.de>);
        Tue, 3 May 2022 13:26:29 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:40584 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234526AbiECR02 (ORCPT
        <rfc822;linux-renesas-soc@vger.kernel.org>);
        Tue, 3 May 2022 13:26:28 -0400
Received: from xavier.telenet-ops.be (xavier.telenet-ops.be [IPv6:2a02:1800:120:4::f00:14])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id C670A1EEDA
        for <linux-renesas-soc@vger.kernel.org>; Tue,  3 May 2022 10:22:53 -0700 (PDT)
Received: from ramsan.of.borg ([IPv6:2a02:1810:ac12:ed40:cd2b:85eb:bdf:a9c3])
        by xavier.telenet-ops.be with bizsmtp
        id SHNq2700D3SeZYW01HNq3c; Tue, 03 May 2022 19:22:50 +0200
Received: from rox.of.borg ([192.168.97.57])
        by ramsan.of.borg with esmtps  (TLS1.3) tls TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384
        (Exim 4.93)
        (envelope-from <geert@linux-m68k.org>)
        id 1nlwEc-002uaq-DO
        for linux-renesas-soc@vger.kernel.org; Tue, 03 May 2022 19:22:50 +0200
Received: from geert by rox.of.borg with local (Exim 4.93)
        (envelope-from <geert@linux-m68k.org>)
        id 1nlwEb-008zjB-Mk
        for linux-renesas-soc@vger.kernel.org; Tue, 03 May 2022 19:22:49 +0200
From:   Geert Uytterhoeven <geert+renesas@glider.be>
To:     linux-renesas-soc@vger.kernel.org
Subject: renesas-drivers-2022-05-03-v5.18-rc5
Date:   Tue,  3 May 2022 19:22:49 +0200
Message-Id: <20220503172249.2143862-1-geert+renesas@glider.be>
...
I have pushed renesas-drivers-2022-05-03-v5.18-rc5 to
...
Today's version is based on renesas-devel-2022-05-03-v5.18-rc5.

Included branches with driver code:
  - renesas-clk-for-v5.19
  - renesas-pinctrl-for-v5.19
  - topic/pinctrl-reserved-field-optimizations-v1
  - topic/rcar-v3u-is-gen4-v1
  - git://git.kernel.org/pub/scm/linux/kernel/git/wsa/linux.git#renesas/gpio-logic-analyzer-v8~1

Included fixes:
  - Revert "USB: gadget: Add a new bus for gadgets"
