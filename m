...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 30139636737
	for <lists+linux-renesas-soc@lfdr.de>; Wed, 23 Nov 2022 18:30:46 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S238944AbiKWRap (ORCPT <rfc822;lists+linux-renesas-soc@lfdr.de>);
        Wed, 23 Nov 2022 12:30:45 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:48112 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S239049AbiKWRaW (ORCPT
        <rfc822;linux-renesas-soc@vger.kernel.org>);
        Wed, 23 Nov 2022 12:30:22 -0500
Received: from relmlie6.idc.renesas.com (relmlor2.renesas.com [210.160.252.172])
        by lindbergh.monkeyblade.net (Postfix) with ESMTP id CB0F18CFE4
        for <linux-renesas-soc@vger.kernel.org>; Wed, 23 Nov 2022 09:30:18 -0800 (PST)
X-IronPort-AV: E=Sophos;i="5.96,187,1665414000"; 
   d="scan'208";a="143666706"
Received: from unknown (HELO relmlir6.idc.renesas.com) ([10.200.68.152])
  by relmlie6.idc.renesas.com with ESMTP; 24 Nov 2022 02:30:18 +0900
Received: from localhost.localdomain (unknown [10.226.92.61])
        by relmlir6.idc.renesas.com (Postfix) with ESMTP id C6CCC40AE606;
        Thu, 24 Nov 2022 02:30:15 +0900 (JST)
...
Subject: [PATCH v6 19/19] drm: rcar-du: Add RZ/G2L DU Support
Date:   Wed, 23 Nov 2022 17:29:06 +0000
Message-Id: <20221123172906.2919734-20-biju.das.jz@bp.renesas.com>
...
The DU module is connected to VSPD. This patch adds support for
...
index 12fb2bb873dc..618384c861f0 100644
...
@@ -65,8 +77,9 @@ config DRM_RZG2L_MIPI_DSI
 config DRM_RCAR_VSP
...
@@ -78,7 +91,7 @@ config DRM_RCAR_WRITEBACK
 config DRM_RCAR_LIB
 	bool
 	default y
-	depends on DRM_RCAR_DU
...
index 000000000000..a60756f985e7
--- /dev/null
...
new file mode 100644
index 000000000000..3ce55f2d2b3d
--- /dev/null
...
new file mode 100644
index 000000000000..4c45b9b8441e
--- /dev/null
...
new file mode 100644
index 000000000000..1f619c2362fe
--- /dev/null
...
new file mode 100644
index 000000000000..cf4ed49f3db1
--- /dev/null
...
new file mode 100644
index 000000000000..c39a0c7cd12f
--- /dev/null
...
new file mode 100644
index 000000000000..5b7f0ebd2a06
--- /dev/null
...
new file mode 100644
index 000000000000..c56d29953d2b
--- /dev/null
...
new file mode 100644
index 000000000000..e6da657b77c5
--- /dev/null
...
new file mode 100644
index 000000000000..b9d7da42b0da
--- /dev/null
