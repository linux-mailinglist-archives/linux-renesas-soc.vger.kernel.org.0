Return-Path: <linux-renesas-soc+bounces-27167-lists+linux-renesas-soc=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-renesas-soc@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id aDisMEM5cGmgXAAAu9opvQ
	(envelope-from <linux-renesas-soc+bounces-27167-lists+linux-renesas-soc=lfdr.de@vger.kernel.org>)
	for <lists+linux-renesas-soc@lfdr.de>; Wed, 21 Jan 2026 03:26:11 +0100
X-Original-To: lists+linux-renesas-soc@lfdr.de
Received: from ams.mirrors.kernel.org (ams.mirrors.kernel.org [213.196.21.55])
	by mail.lfdr.de (Postfix) with ESMTPS id 87C554FBDE
	for <lists+linux-renesas-soc@lfdr.de>; Wed, 21 Jan 2026 03:26:11 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ams.mirrors.kernel.org (Postfix) with ESMTPS id A02F19AFD7A
	for <lists+linux-renesas-soc@lfdr.de>; Wed, 21 Jan 2026 02:24:19 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 8621932F742;
...
X-Spamd-Result: default: False [-1.96 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-27167-lists,linux-renesas-soc=lfdr.de];
	RCVD_TLS_LAST(0.00)[];
	...
	MISSING_XM_UA(0.00)[];
	DBL_BLOCKED_OPENRESOLVER(0.00)[get-maintainers.pl:url,ams.mirrors.kernel.org:rdns,ams.mirrors.kernel.org:helo,mailbox.org:mid,mailbox.org:dkim,msgid.link:url,get_maintainer.pl:url]
X-Rspamd-Queue-Id: 87C554FBDE
