Return-Path: <linux-renesas-soc+bounces-28325-lists+linux-renesas-soc=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-renesas-soc@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id YHTkALqQl2mU0gIAu9opvQ
	(envelope-from <linux-renesas-soc+bounces-28325-lists+linux-renesas-soc=lfdr.de@vger.kernel.org>)
	for <lists+linux-renesas-soc@lfdr.de>; Thu, 19 Feb 2026 23:37:46 +0100
X-Original-To: lists+linux-renesas-soc@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [IPv6:2600:3c0a:e001:db::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id 7AAAA16341D
	for <lists+linux-renesas-soc@lfdr.de>; Thu, 19 Feb 2026 23:37:45 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id 4157E3037D54
	for <lists+linux-renesas-soc@lfdr.de>; Thu, 19 Feb 2026 22:37:04 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id C15D432B9A1;
	Thu, 19 Feb 2026 22:37:03 +0000 (UTC)
X-Original-To: linux-renesas-soc@vger.kernel.org
Received: from relmlie5.idc.renesas.com (relmlor1.renesas.com [210.160.252.171])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id C62262EDD52;
	Thu, 19 Feb 2026 22:37:01 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=210.160.252.171
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1771540623; cv=none; b=O0h1OvOumb9izS5WhWuFaZE3hS99diskVfDiJHHW+VMVU4bQ4/AqEGRxB092Fg/huT9K0sUWpp+KKFc+w8wQIInwDSrR9kiJaAX9QRB++iqxleoPTKnVCqo/8JEqBLPTMT99h5QFrKOcov7PoOO1jzJb15Jrjv7ZVFmdrCTglqY=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1771540623; c=relaxed/simple;
	bh=Bl1o535C5UWaGrQQJNHhq6Fy8ke6d7kk5Q1gz98Gzlg=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=sC7Ts7nHXo1GR6l3/9T+B++kxLxlMO46PKOvTOebbjtdwoNFZ95jxhvQ60IZ0U5X9Vss2Kp3iAGxwyHjZ11Gg3Pxe22K2MYUF7uF2V/3Gh7+anbJKTEpaCw8gkr6YjFGTfyc8CGZw4Xp3x1EyYt85qkFnUPhP13I3FQhZVmUURQ=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=bp.renesas.com; spf=pass smtp.mailfrom=bp.renesas.com; arc=none smtp.client-ip=210.160.252.171
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=bp.renesas.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=bp.renesas.com
X-CSE-ConnectionGUID: 8Fh+bd2PS+mrjJA1kjGdiQ==
X-CSE-MsgGUID: AtjiiW6jSh6o6iyAoHyVDw==
Received: from unknown (HELO relmlir5.idc.renesas.com) ([10.200.68.151])
  by relmlie5.idc.renesas.com with ESMTP; 20 Feb 2026 07:37:00 +0900
Received: from ubuntu.adwin.renesas.com (unknown [10.24.0.22])
	by relmlir5.idc.renesas.com (Postfix) with ESMTP id 3D4684010DDE;
	Fri, 20 Feb 2026 07:36:54 +0900 (JST)
...
Subject: [PATCH v6 10/16] PCI: rzg3s-host: Add SoC-specific configuration and initialization callbacks
Date: Thu, 19 Feb 2026 23:35:36 +0100
Message-ID: <20260219223542.6364-11-john.madieu.xa@bp.renesas.com>
...
X-Spamd-Result: default: False [1.64 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	RCVD_TLS_LAST(0.00)[];
	TAGGED_FROM(0.00)[bounces-28325-lists,linux-renesas-soc=lfdr.de];
...
index 338d135154c6..c66532a3dae0 100644
--- a/drivers/pci/controller/pcie-rzg3s-host.c
+++ b/drivers/pci/controller/pcie-rzg3s-host.c
@@ -234,6 +234,9 @@ struct rzg3s_pcie_host;
 /**
...
@@ -244,6 +247,9 @@ struct rzg3s_pcie_host;
  */
...
@@ -1093,6 +1099,18 @@ static int rzg3s_pcie_config_init(struct rzg3s_pcie_host *host)
 	return 0;
 }
...
+
 ...
 {
 	/*
@@ -1265,22 +1283,26 @@ static int rzg3s_pcie_host_init(struct rzg3s_pcie_host *host)
 	u32 val;
 	int ret;
...
@@ -1289,18 +1311,20 @@ static int rzg3s_pcie_host_init(struct rzg3s_pcie_host *host)
...
@@ -1661,7 +1685,7 @@ static int rzg3s_pcie_probe(struct platform_device *pdev)
...
+	host->data->config_deinit(host);
 ...
 rpm_disable:
@@ -1694,15 +1718,15 @@ static int rzg3s_pcie_suspend_noirq(struct device *dev)
...
+		goto config_reinit;
 	...
 	if (ret)
@@ -1714,9 +1738,10 @@ static int rzg3s_pcie_suspend_noirq(struct device *dev)
...
@@ -1781,6 +1806,8 @@ static const struct rzg3s_pcie_soc_data rzg3s_soc_data = {
