...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 07A6564F299
	for <lists+linux-renesas-soc@lfdr.de>; Fri, 16 Dec 2022 21:50:57 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231980AbiLPUuz (ORCPT <rfc822;lists+linux-renesas-soc@lfdr.de>);
        Fri, 16 Dec 2022 15:50:55 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:43794 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231822AbiLPUuw (ORCPT
        <rfc822;linux-renesas-soc@vger.kernel.org>);
        Fri, 16 Dec 2022 15:50:52 -0500
Received: from relmlie6.idc.renesas.com (relmlor2.renesas.com [210.160.252.172])
        by lindbergh.monkeyblade.net (Postfix) with ESMTP id 51CE817072;
        Fri, 16 Dec 2022 12:50:48 -0800 (PST)
X-IronPort-AV: E=Sophos;i="5.96,251,1665414000"; 
   d="scan'208";a="146465857"
Received: from unknown (HELO relmlir6.idc.renesas.com) ([10.200.68.152])
  by relmlie6.idc.renesas.com with ESMTP; 17 Dec 2022 05:50:47 +0900
Received: from localhost.localdomain (unknown [10.226.92.240])
        by relmlir6.idc.renesas.com (Postfix) with ESMTP id 5B58740DAABE;
        Sat, 17 Dec 2022 05:50:45 +0900 (JST)
...
Subject: [PATCH v10 4/5] counter: Add Renesas RZ/G2L MTU3a counter driver
Date:   Fri, 16 Dec 2022 20:50:27 +0000
Message-Id: <20221216205028.340795-5-biju.das.jz@bp.renesas.com>
...
index 000000000000..371a3d1563ed
--- /dev/null
...
+}
+
+static bool rz_mtu3_is_ch0_enabled(struct rz_mtu3_cnt *const priv)
+{
+	return priv->count_is_enabled[RZ_MTU3_16_BIT_MTU1_CH] ||
...
+	}
+
+	err = rz_mtu3_count_function_read_helper(ch, priv, &function);
+	if (err) {
+		mutex_unlock(&priv->lock);
+		return err;
+	}
