Return-Path: <linux-renesas-soc+bounces-27904-lists+linux-renesas-soc=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-renesas-soc@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id uOziHWZ1g2mFmwMAu9opvQ
	(envelope-from <linux-renesas-soc+bounces-27904-lists+linux-renesas-soc=lfdr.de@vger.kernel.org>)
	for <lists+linux-renesas-soc@lfdr.de>; Wed, 04 Feb 2026 17:35:50 +0100
X-Original-To: lists+linux-renesas-soc@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [IPv6:2600:3c0a:e001:db::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id 91553EA52F
	for <lists+linux-renesas-soc@lfdr.de>; Wed, 04 Feb 2026 17:35:49 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id 4D53A303A6D0
	for <lists+linux-renesas-soc@lfdr.de>; Wed,  4 Feb 2026 16:29:51 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id BEEB9428841;
	Wed,  4 Feb 2026 16:29:32 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=ideasonboard.com header.i=@ideasonboard.com header.b="PTuhEJn9"
X-Original-To: linux-renesas-soc@vger.kernel.org
Received: from perceval.ideasonboard.com (perceval.ideasonboard.com [213.167.242.64])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id DBDC2428833;
	Wed,  4 Feb 2026 16:29:31 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=213.167.242.64
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1770222572; cv=none; b=FXVGL9VUsokzrvR3Zr84qwIp4X9t2UGqSstCkjSjKu2ancivGnZJRV6xELCZlyLsuFdwr3AcgHzbsCMiJNU0dnQiHyINerOrKxMxK7U+3cU1go1dMGrNXupjtr+iLpUHb3XXJ2whnMcNtiQDiSTOlKbJGMgTv3mtMjspbEzD2lY=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1770222572; c=relaxed/simple;
	bh=+3kTtwmDv1ef/WwD9QY39lvC/dPJBMQGGsG/zdGFo4Q=;
	h=Date:From:To:Cc:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=oYNEo60CJtzW4SjP4P6K7iHw+mWYO21eJ7KgD3D5CRyw2sqDq7mgY4V/cKqpoHUqRBMMuouQW1FxwZRA1JgtGc8FtnPQkskY9ZnA9v++4Nj9M1+XeNVNDI2jxB6Ptc0cMbdaa/fUivO9iLWEL4jf3Ii+Kbc3JjoRCSFdKz61cq0=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=ideasonboard.com; spf=pass smtp.mailfrom=ideasonboard.com; dkim=pass (1024-bit key) header.d=ideasonboard.com header.i=@ideasonboard.com header.b=PTuhEJn9; arc=none smtp.client-ip=213.167.242.64
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=ideasonboard.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=ideasonboard.com
Received: from ideasonboard.com (net-93-65-100-155.cust.vodafonedsl.it [93.65.100.155])
	by perceval.ideasonboard.com (Postfix) with ESMTPSA id 586B2593;
	Wed,  4 Feb 2026 17:28:47 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=ideasonboard.com;
	s=mail; t=1770222527;
	bh=+3kTtwmDv1ef/WwD9QY39lvC/dPJBMQGGsG/zdGFo4Q=;
	h=Date:From:To:Cc:Subject:References:In-Reply-To:From;
	b=PTuhEJn99L1Ti54AlRbs5KA7bDlmOa2MfjlPnVDQ4C9bMd2Th6WKzzYwoWz9Jh7Ds
	 xJoDN/L/jrUe8gjTNehKhFm4ZPpr0b0z4a1TZZH9TPalKN6z7LTQIfazURJJVIX32M
	 jx1x25xLtXV2MBof34vku99fx95NLA1ST4EkNxeU=
Date: Wed, 4 Feb 2026 17:29:26 +0100
...
Cc: Mauro Carvalho Chehab <mchehab@kernel.org>, 
	...
	linux-kernel@vger.kernel.org, Marek Vasut' <marek.vasut+renesas@mailbox.org>
Subject: Re: [PATCH v5 02/12] media: rcar-isp: Add support for ISPCORE
Message-ID: <aYNyLgXDN7BUj0aT@zed>
References: <20251225171054.1370856-1-niklas.soderlund+renesas@ragnatech.se>
 <20251225171054.1370856-3-niklas.soderlund+renesas@ragnatech.se>
Precedence: bulk
...
In-Reply-To: <20251225171054.1370856-3-niklas.soderlund+renesas@ragnatech.se>
...
X-Spamd-Result: default: False [-0.16 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	TAGGED_FROM(0.00)[bounces-27904-lists,linux-renesas-soc=lfdr.de];
	RCVD_TLS_LAST(0.00)[];
	FROM_HAS_DN(0.00)[];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[sea.lore.kernel.org:helo,sea.lore.kernel.org:rdns,desc.base:url,ideasonboard.com:dkim]
X-Rspamd-Queue-Id: 91553EA52F
X-Rspamd-Action: no action

Hi Niklas,
  a small note on the parameters buffer handling

On Thu, Dec 25, 2025 at 06:10:44PM +0100, Niklas Söderlund wrote:
...
We have now introduced the v4l2-isp framework in v6.19, which can help drivers
doing validation.

Have a look at how, in example, mali use it:
https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/drivers/media/platform/arm/mali-c55/mali-c55-params.c?h=v6.19-rc8#n576
or rockchip:
https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/drivers/media/platform/rockchip/rkisp1/rkisp1-params.c?h=v6.19-rc8#n2657

I guess you can simply call v4l2_isp_params_validate_buffer_size() and
v4l2_isp_params_validate_buffer() and it should work.
