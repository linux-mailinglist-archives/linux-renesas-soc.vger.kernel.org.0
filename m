...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 1EF1B262F7A
	for <lists+linux-renesas-soc@lfdr.de>; Wed,  9 Sep 2020 16:06:31 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727804AbgIIOGF (ORCPT <rfc822;lists+linux-renesas-soc@lfdr.de>);
        Wed, 9 Sep 2020 10:06:05 -0400
Received: from relmlor1.renesas.com ([210.160.252.171]:7238 "EHLO
        relmlie5.idc.renesas.com" rhost-flags-OK-OK-OK-FAIL)
        by vger.kernel.org with ESMTP id S1730224AbgIINOU (ORCPT
        <rfc822;linux-renesas-soc@vger.kernel.org>);
        Wed, 9 Sep 2020 09:14:20 -0400
X-IronPort-AV: E=Sophos;i="5.76,409,1592838000"; 
   d="scan'208";a="56837038"
Received: from unknown (HELO relmlir6.idc.renesas.com) ([10.200.68.152])
  by relmlie5.idc.renesas.com with ESMTP; 09 Sep 2020 22:13:42 +0900
Received: from localhost.localdomain (unknown [10.166.252.89])
        by relmlir6.idc.renesas.com (Postfix) with ESMTP id 98B4849DB584;
        Wed,  9 Sep 2020 22:13:42 +0900 (JST)
From:   Yoshihiro Shimoda <yoshihiro.shimoda.uh@renesas.com>
To:     geert+renesas@glider.be, magnus.damm@gmail.com
Cc:     linux-renesas-soc@vger.kernel.org,
        Yoshihiro Shimoda <yoshihiro.shimoda.uh@renesas.com>
Subject: [PATCH v2 4/4] clk: renesas: cpg-mssr: Add support for R-Car V3U
Date:   Wed,  9 Sep 2020 22:13:31 +0900
Message-Id: <1599657211-17504-5-git-send-email-yoshihiro.shimoda.uh@renesas.com>
...
---
 ...
 drivers/clk/renesas/renesas-cpg-mssr.c  |  21 ++-
...
@@ -135,7 +145,7 @@ struct cpg_mssr_priv {
 	struct {
 		u32 mask;
 		u32 val;
...
@@ -799,6 +809,12 @@ static const struct of_device_id cpg_mssr_match[] = {
...
+	CLK_REG_LAYOUT_RCAR_V3U,
     ...
     /**
@@ -179,6 +180,7 @@ extern const struct cpg_mssr_info r8a77970_cpg_mssr_info;
