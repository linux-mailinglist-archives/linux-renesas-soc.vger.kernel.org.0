Return-Path: <linux-renesas-soc+bounces-17235-lists+linux-renesas-soc=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-renesas-soc@lfdr.de
Delivered-To: lists+linux-renesas-soc@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 5C7A7ABCF23
	for <lists+linux-renesas-soc@lfdr.de>; Tue, 20 May 2025 08:22:24 +0200 (CEST)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 90C171B60930
	for <lists+linux-renesas-soc@lfdr.de>; Tue, 20 May 2025 06:22:34 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 1337225CC46;
	Tue, 20 May 2025 06:22:15 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b="Rw6cGxSC"
X-Original-To: linux-renesas-soc@vger.kernel.org
Received: from mgamail.intel.com (mgamail.intel.com [198.175.65.11])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id A535A25A2DE;
	Tue, 20 May 2025 06:22:02 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=198.175.65.11
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1747722134; cv=none; b=txsEgZosvtTwGCnIKM5niM7Ir5nJi57qf2AzxasBik3ATT67Y27YRl+RGvyrwPwoXwIy5WUrdpJfZ8r+L+U2+KNwgDrOs3in2U5sZFaAy866UX3QaOqi/9IAif11ebnTIy4ovFqPhCVjrN6EgQOkOJq63WMKa0PsqiZ0+27kwK4=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1747722134; c=relaxed/simple;
	bh=FfwZGTSLK0+Hr9oZ0YNKUvC5r0q6TAUgiRLcSebUaYU=;
	h=Date:From:To:Cc:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=Y76CE0rHM0dHMHp89ayTewmZl7rizJn1RWofZM0m3SQHiE4XclednG+OYv65mXDMNJkdgzqKf/Evf/eCpjSv76C88cz5WSf4TaaaFGAYXvy2zLJAaJYs7IIZXwhkrBmmPCBb5Q8cceDRq73onQb91k9SghgxF6lEWUfogKsesEY=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com; spf=pass smtp.mailfrom=intel.com; dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b=Rw6cGxSC; arc=none smtp.client-ip=198.175.65.11
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=intel.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1747722123; x=1779258123;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:in-reply-to;
  bh=FfwZGTSLK0+Hr9oZ0YNKUvC5r0q6TAUgiRLcSebUaYU=;
  b=Rw6cGxSCdMoqx5WF3/dtl/Xoe2aH5g0AhW44/GkdXy7jX3ONYetVJjxe
   HDc5wRtnw5jfCpztJ0iVcLvN57eo6En7d5kiinmtiqJnqcIJlpGO/XxQS
   n61ReoHmoaNO5ye1KCNP2E7nYad7AGkIlTDb6gEoniDupN7v1B/R2M3b0
   tJR39KIX8Q4IDHWSlmUmGm1tY6qYiBbbfOR66w1J8ZUsjne8xScRcE8W5
   /UYYt4TO3JbpGuPTeOnqSeHOZano5bEEtbBshOVbbWsFRm1pnTfoEIiFW
   Pzt+4fdGlaZllpDHGEL/Rf3qxh5+tK+3oeAmlHYjAolatBZ5dqZWer0sg
   w==;
X-CSE-ConnectionGUID: CLC3HZO/Q7e4+NX/MPdduw==
X-CSE-MsgGUID: JOX2oE8ySSiYWItiynZ2mA==
X-IronPort-AV: E=McAfee;i="6700,10204,11438"; a="59869592"
X-IronPort-AV: E=Sophos;i="6.15,302,1739865600"; 
   d="scan'208";a="59869592"
Received: from fmviesa008.fm.intel.com ([10.60.135.148])
  by orvoesa103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 19 May 2025 23:22:01 -0700
X-CSE-ConnectionGUID: TOV4piSETA6031rRc4xAgQ==
X-CSE-MsgGUID: Yo8tmVX3R2uuDq0FGwKQKA==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.15,302,1739865600"; 
   d="scan'208";a="140008264"
Received: from lkp-server01.sh.intel.com (HELO 1992f890471c) ([10.239.97.150])
  by fmviesa008.fm.intel.com with ESMTP; 19 May 2025 23:21:56 -0700
Received: from kbuild by 1992f890471c with local (Exim 4.96)
	(envelope-from <lkp@intel.com>)
	id 1uHGMM-000MDU-18;
	Tue, 20 May 2025 06:21:54 +0000
Date: Tue, 20 May 2025 14:21:03 +0800
...
Subject: Re: [PATCH 2/3] media: platform: Add Renesas Input Video Control
 block driver
Message-ID: <202505201401.pBuegZJE-lkp@intel.com>
...
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="nEZZkVvjmgd2/hgc"
...
[also build test ERROR on sailus-media-tree/streams sailus-media-tree/master v6.15-rc7 next-20250516]
...
| Closes: https://lore.kernel.org/oe-kbuild-all/202505201401.pBuegZJE-lkp@intel.com/

All errors (new ones prefixed by >>):

>> drivers/media/platform/renesas/rzv2h-ivc/rzv2h-ivc-subdev.c:38:25: error: 'MEDIA_BUS_FMT_SBGGR20_1X20' undeclared here (not in a function); did you mean 'MEDIA_BUS_FMT_SBGGR10_1X10'?
      38 |                         MEDIA_BUS_FMT_SBGGR20_1X20,
         |                         ^~~~~~~~~~~~~~~~~~~~~~~~~~
         |                         MEDIA_BUS_FMT_SBGGR10_1X10
>> drivers/media/platform/renesas/rzv2h-ivc/rzv2h-ivc-subdev.c:49:25: error: 'MEDIA_BUS_FMT_SGBRG20_1X20' undeclared here (not in a function); did you mean 'MEDIA_BUS_FMT_SGBRG10_1X10'?
      49 |                         MEDIA_BUS_FMT_SGBRG20_1X20,
         |                         ^~~~~~~~~~~~~~~~~~~~~~~~~~
         |                         MEDIA_BUS_FMT_SGBRG10_1X10
>> drivers/media/platform/renesas/rzv2h-ivc/rzv2h-ivc-subdev.c:60:25: error: 'MEDIA_BUS_FMT_SGRBG20_1X20' undeclared here (not in a function); did you mean 'MEDIA_BUS_FMT_SGRBG10_1X10'?
      60 |                         MEDIA_BUS_FMT_SGRBG20_1X20,
         |                         ^~~~~~~~~~~~~~~~~~~~~~~~~~
         |                         MEDIA_BUS_FMT_SGRBG10_1X10
>> drivers/media/platform/renesas/rzv2h-ivc/rzv2h-ivc-subdev.c:71:25: error: 'MEDIA_BUS_FMT_SRGGB20_1X20' undeclared here (not in a function); did you mean 'MEDIA_BUS_FMT_SRGGB10_1X10'?
      71 |                         MEDIA_BUS_FMT_SRGGB20_1X20,
         |                         ^~~~~~~~~~~~~~~~~~~~~~~~~~
         |                         MEDIA_BUS_FMT_SRGGB10_1X10


vim +38 drivers/media/platform/renesas/rzv2h-ivc/rzv2h-ivc-subdev.c

    22	
    23	/*
    24	 * We support 8/10/12/14/16/20 bit input in any bayer order, but the output
    25	 * format is fixed at 20-bits with the same order as the input.
    26	 */
    27	static const struct {
    28		u32 inputs[RZV2H_IVC_N_INPUTS_PER_OUTPUT];
    29		u32 output;
    30	} rzv2h_ivc_formats[] = {
    31		{
    32			.inputs = {
    33				MEDIA_BUS_FMT_SBGGR8_1X8,
    34				MEDIA_BUS_FMT_SBGGR10_1X10,
    35				MEDIA_BUS_FMT_SBGGR12_1X12,
    36				MEDIA_BUS_FMT_SBGGR14_1X14,
    37				MEDIA_BUS_FMT_SBGGR16_1X16,
  > 38				MEDIA_BUS_FMT_SBGGR20_1X20,
    39			},
    40			.output = MEDIA_BUS_FMT_SBGGR20_1X20
    41		},
    42		{
    43			.inputs = {
    44				MEDIA_BUS_FMT_SGBRG8_1X8,
    45				MEDIA_BUS_FMT_SGBRG10_1X10,
    46				MEDIA_BUS_FMT_SGBRG12_1X12,
    47				MEDIA_BUS_FMT_SGBRG14_1X14,
    48				MEDIA_BUS_FMT_SGBRG16_1X16,
  > 49				MEDIA_BUS_FMT_SGBRG20_1X20,
    50			},
    51			.output = MEDIA_BUS_FMT_SGBRG20_1X20
    52		},
    53		{
    54			.inputs = {
    55				MEDIA_BUS_FMT_SGRBG8_1X8,
    56				MEDIA_BUS_FMT_SGRBG10_1X10,
    57				MEDIA_BUS_FMT_SGRBG12_1X12,
    58				MEDIA_BUS_FMT_SGRBG14_1X14,
    59				MEDIA_BUS_FMT_SGRBG16_1X16,
  > 60				MEDIA_BUS_FMT_SGRBG20_1X20,
    61			},
    62			.output = MEDIA_BUS_FMT_SGRBG20_1X20
    63		},
    64		{
    65			.inputs = {
    66				MEDIA_BUS_FMT_SRGGB8_1X8,
    67				MEDIA_BUS_FMT_SRGGB10_1X10,
    68				MEDIA_BUS_FMT_SRGGB12_1X12,
    69				MEDIA_BUS_FMT_SRGGB14_1X14,
    70				MEDIA_BUS_FMT_SRGGB16_1X16,
  > 71				MEDIA_BUS_FMT_SRGGB20_1X20,
    72			},
    73			.output = MEDIA_BUS_FMT_SRGGB20_1X20
    74		},
    75	};
    76	
...
reproduce (this is a W=1 build):
        ...
        b4 shazam https://lore.kernel.org/r/20250519145754.454005-3-dan.scally@ideasonboard.com
        # save the config file
        mkdir build_dir && cp config build_dir/.config
        COMPILER_INSTALL_PATH=$HOME/0day COMPILER=gcc-14.2.0 ~/lkp-tests/kbuild/make.cross W=1 O=build_dir ARCH=sparc olddefconfig
        COMPILER_INSTALL_PATH=$HOME/0day COMPILER=gcc-14.2.0 ~/lkp-tests/kbuild/make.cross W=1 O=build_dir ARCH=sparc SHELL=/bin/bash drivers/media/platform/renesas/rzv2h-ivc/
...
# Linux/sparc 6.15.0-rc7 Kernel Configuration
#
