...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 325C2512C02
	for <lists+linux-renesas-soc@lfdr.de>; Thu, 28 Apr 2022 08:54:08 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233129AbiD1G5K (ORCPT <rfc822;lists+linux-renesas-soc@lfdr.de>);
        Thu, 28 Apr 2022 02:57:10 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:59476 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S244610AbiD1G5J (ORCPT
        <rfc822;linux-renesas-soc@vger.kernel.org>);
        Thu, 28 Apr 2022 02:57:09 -0400
Received: from relmlie5.idc.renesas.com (relmlor1.renesas.com [210.160.252.171])
        by lindbergh.monkeyblade.net (Postfix) with ESMTP id AFE17986D8;
        Wed, 27 Apr 2022 23:53:55 -0700 (PDT)
X-IronPort-AV: E=Sophos;i="5.90,295,1643641200"; 
   d="scan'208";a="118286408"
Received: from unknown (HELO relmlir5.idc.renesas.com) ([10.200.68.151])
  by relmlie5.idc.renesas.com with ESMTP; 28 Apr 2022 15:53:55 +0900
Received: from localhost.localdomain (unknown [10.226.92.182])
        by relmlir5.idc.renesas.com (Postfix) with ESMTP id 5677B401091F;
        Thu, 28 Apr 2022 15:53:52 +0900 (JST)
...
Subject: [PATCH v9 4/5] media: renesas: vsp1: Add VSP1_HAS_NON_ZERO_LBA feature bit
Date:   Thu, 28 Apr 2022 07:53:32 +0100
Message-Id: <20220428065333.3108-5-biju.das.jz@bp.renesas.com>
...
index 1aa7f87d86b6..ec845d50037b 100644
--- a/drivers/media/platform/renesas/vsp1/vsp1_drv.c
+++ b/drivers/media/platform/renesas/vsp1/vsp1_drv.c
@@ -780,6 +780,7 @@ static const struct vsp1_device_info vsp1_device_infos[] = {
 	}, {
...
+		.soc = VI6_IP_VERSION_SOC_V3H,
 		...
 		.lif_count = 1,
@@ -787,6 +788,17 @@ static const struct vsp1_device_info vsp1_device_infos[] = {
 		.uif_count = 1,
 		.wpf_count = 1,
 		.num_bru_inputs = 5,
+	}, {
...
+		.num_bru_inputs = 5,
 		...
 		.model = "VSP2-DL",
@@ -830,8 +842,12 @@ static const struct vsp1_device_info *vsp1_lookup_info(struct vsp1_device *vsp1)
