Return-Path: <linux-renesas-soc+bounces-13703-lists+linux-renesas-soc=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-renesas-soc@lfdr.de
Delivered-To: lists+linux-renesas-soc@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 34FA8A46061
	for <lists+linux-renesas-soc@lfdr.de>; Wed, 26 Feb 2025 14:11:41 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 650433A99E6
	for <lists+linux-renesas-soc@lfdr.de>; Wed, 26 Feb 2025 13:11:09 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 0C95021D3F1;
	Wed, 26 Feb 2025 13:10:31 +0000 (UTC)
X-Original-To: linux-renesas-soc@vger.kernel.org
Received: from relmlie6.idc.renesas.com (relmlor2.renesas.com [210.160.252.172])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 92A7A22154A;
	Wed, 26 Feb 2025 13:10:28 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=210.160.252.172
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1740575430; cv=none; b=SpRX7JjrnCPJiaovM4VPLmQMuGoX6VvEPFPzu80gQurhFPOLcx5fb1LvAupLVCF3g8zFg0WCD53THuaxFWzn+/T2MrhwAvCNf+JdRGQm4fM4N7Gk5KcebLlhim7RlyDbND99q01Z0ogCgr+PTDH/llx4au2oBjSwZa1vPKB1WqA=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1740575430; c=relaxed/simple;
	bh=rGXf7KEdmf+m+3vXaYMjhVOKQKQahBdKS6mu2es5IR4=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=itWRhD1qsHNcPUruHimXSPXPmVh5tRDOcv7kuvFd8uIUi7pjgtYgmPRU+np6Yzn8tO0FRHXy30YKH3lVBIshdQXSLjDHKzavR28Mm2PFJFkrZD4Z1TTWNv+hMrm+rIWKxs2yZ11HLJLmPvmasjOW+bghl7Kt7owlL4cDgGkPo7Q=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=bp.renesas.com; spf=pass smtp.mailfrom=bp.renesas.com; arc=none smtp.client-ip=210.160.252.172
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=bp.renesas.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=bp.renesas.com
X-CSE-ConnectionGUID: 0NYwffx7T+yfS397W8gZew==
X-CSE-MsgGUID: ygGLgcJCTKW9czgUJ0eSjg==
Received: from unknown (HELO relmlir5.idc.renesas.com) ([10.200.68.151])
  by relmlie6.idc.renesas.com with ESMTP; 26 Feb 2025 22:10:28 +0900
Received: from superbuilder.administration.lan (unknown [10.226.92.221])
	by relmlir5.idc.renesas.com (Postfix) with ESMTP id ADD9A4069606;
	Wed, 26 Feb 2025 22:10:25 +0900 (JST)
...
Subject: [PATCH v3 09/13] serial: sh-sci: Introduced sci_of_data
Date: Wed, 26 Feb 2025 14:09:28 +0100
Message-ID: <20250226130935.3029927-10-thierry.bultel.yh@bp.renesas.com>
...
---
 ...
 drivers/tty/serial/sh-sci.c        | 162 +++++++++++++++++++++--------
 2 files changed, 130 insertions(+), 42 deletions(-)

diff --git a/drivers/tty/serial/sh-sci-common.h b/drivers/tty/serial/sh-sci-common.h
index 7c3ae52bbd8a..17d0eda0a2ed 100644
--- a/drivers/tty/serial/sh-sci-common.h
+++ b/drivers/tty/serial/sh-sci-common.h
@@ -94,6 +94,14 @@ struct sci_port_ops {
...
@@ -157,7 +165,7 @@ int sci_startup(struct uart_port *port);
...
index 664446ea151c..827b10793b97 100644
--- a/drivers/tty/serial/sh-sci.c
+++ b/drivers/tty/serial/sh-sci.c
@@ -2969,10 +2969,13 @@ static int sci_init_clocks(struct sci_port *sci_port, struct device *dev)
 }
...
@@ -3019,9 +3022,7 @@ static int sci_init_single(struct platform_device *dev,
 	int ret;
...
@@ -3061,10 +3062,6 @@ static int sci_init_single(struct platform_device *dev,
...
@@ -3305,58 +3307,126 @@ static void sci_remove(struct platform_device *dev)
...
@@ -3375,7 +3445,7 @@ static struct plat_sci_port *sci_parse_dt(struct platform_device *pdev,
...
@@ -3422,8 +3492,12 @@ static struct plat_sci_port *sci_parse_dt(struct platform_device *pdev,
 	sp->rstc = rstc;
 	*dev_id = id;
...
@@ -3530,6 +3604,7 @@ static int sci_probe(struct platform_device *dev)
...
+		sp = &sci_ports[dev_id];
 		...
 		if (p == NULL) {
@@ -3538,9 +3613,12 @@ static int sci_probe(struct platform_device *dev)
 		}
...
-	sp = &sci_ports[dev_id];
 	sp->suspend_regs = devm_kzalloc(&dev->dev,
 					...
 					GFP_KERNEL);
@@ -3687,19 +3765,23 @@ static int early_console_exit(struct console *co)
 }
...
@@ -3716,41 +3798,39 @@ int __init scix_early_console_setup(struct earlycon_device *device,
