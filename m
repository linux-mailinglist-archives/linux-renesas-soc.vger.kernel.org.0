Return-Path: <linux-renesas-soc+bounces-13699-lists+linux-renesas-soc=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-renesas-soc@lfdr.de
Delivered-To: lists+linux-renesas-soc@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id D5ABAA46055
	for <lists+linux-renesas-soc@lfdr.de>; Wed, 26 Feb 2025 14:10:49 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 8526C3AE979
	for <lists+linux-renesas-soc@lfdr.de>; Wed, 26 Feb 2025 13:10:28 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 29869213235;
	Wed, 26 Feb 2025 13:10:13 +0000 (UTC)
X-Original-To: linux-renesas-soc@vger.kernel.org
Received: from relmlie5.idc.renesas.com (relmlor1.renesas.com [210.160.252.171])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 1067921D3FB;
	Wed, 26 Feb 2025 13:10:09 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=210.160.252.171
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1740575413; cv=none; b=VS1XNZZS5DMvXuSusqHzqAnk7NThxyNeIJ4q/jR9NZ5gmfE0HVpC541JFbmPgoX1h6uiLIREpkuD4Bar39a4eY4UrkvVW9HebMpMDvzJ+Xspm3u5nRYDfs4/fBmCQjBcGCxpnyMKtQAXgghP2rmhm3h6PNqrF71BjRIkaMA8rtM=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1740575413; c=relaxed/simple;
	bh=aRWQdJcZ1J7hSTG1ziCT135v3K+vt+UKcRNHS+V6YM4=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=t4eC3pvkYI7PCyg3CfixZ8fv+E7Q+Z9D4dzWStHVGXSoDHeIz4Nb3ibY67KQD+1HAjNgFBSlTfdV6vxT6g238zjgBJldQE+8g63OL5mkSoy4A+LVXQhrsORpiacHuia7CRpG3A48q/JdHBXRnP3AvfUMAU8OP6qYK5KQO8oXfxE=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=bp.renesas.com; spf=pass smtp.mailfrom=bp.renesas.com; arc=none smtp.client-ip=210.160.252.171
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=bp.renesas.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=bp.renesas.com
X-CSE-ConnectionGUID: zNJBO5iyRq6pXQETLOw0Cw==
X-CSE-MsgGUID: g/uis2rxTKKyjSJOEiUvjA==
Received: from unknown (HELO relmlir5.idc.renesas.com) ([10.200.68.151])
  by relmlie5.idc.renesas.com with ESMTP; 26 Feb 2025 22:10:09 +0900
Received: from superbuilder.administration.lan (unknown [10.226.92.221])
	by relmlir5.idc.renesas.com (Postfix) with ESMTP id 2E31C4069606;
	Wed, 26 Feb 2025 22:10:06 +0900 (JST)
...
Subject: [PATCH v3 05/13] clk: renesas: Pass sub struct of cpg_mssr_priv to cpg_clk_register
Date: Wed, 26 Feb 2025 14:09:24 +0100
Message-ID: <20250226130935.3029927-6-thierry.bultel.yh@bp.renesas.com>
...
index bf85501709f0..b78992217e58 100644
...
@@ -352,7 +351,7 @@ static void __init cpg_mssr_register_core_clk(const struct cpg_core_clk *core,
...
+		parent = priv->pub.clks[core->parent];
 		if (IS_ERR(parent)) {
 			clk = parent;
 			goto fail;
@@ -362,12 +361,12 @@ static void __init cpg_mssr_register_core_clk(const struct cpg_core_clk *core,
...
+						&priv->pub.notifiers);
 			...
 			clk = clk_register_fixed_factor(NULL, core->name,
 							parent_name, 0,
@@ -383,8 +382,7 @@ static void __init cpg_mssr_register_core_clk(const struct cpg_core_clk *core,
 	default:
...
+						     &priv->pub);
 			...
 			dev_err(dev, "%s has unsupported core clock type %u\n",
 				core->name, core->type);
@@ -395,7 +393,7 @@ static void __init cpg_mssr_register_core_clk(const struct cpg_core_clk *core,
 		goto fail;
...
+	priv->pub.clks[id] = clk;
 ...
 fail:
@@ -418,14 +416,14 @@ static void __init cpg_mssr_register_mod_clk(const struct mssr_mod_clk *mod,
...
+	parent = priv->pub.clks[mod->parent];
 	if (IS_ERR(parent)) {
 		clk = parent;
 		goto fail;
@@ -627,13 +625,13 @@ static int cpg_mssr_reset(struct reset_controller_dev *rcdev,
...
@@ -647,7 +645,7 @@ static int cpg_mssr_assert(struct reset_controller_dev *rcdev, unsigned long id)
...
@@ -661,7 +659,7 @@ static int cpg_mssr_deassert(struct reset_controller_dev *rcdev,
...
@@ -673,7 +671,7 @@ static int cpg_mssr_status(struct reset_controller_dev *rcdev,
...
@@ -899,12 +897,12 @@ static int cpg_mssr_suspend_noirq(struct device *dev)
...
@@ -921,7 +919,7 @@ static int cpg_mssr_resume_noirq(struct device *dev)
 		return 0;
...
@@ -930,29 +928,29 @@ static int cpg_mssr_resume_noirq(struct device *dev)
 			continue;
...
@@ -1062,12 +1060,13 @@ static int __init cpg_mssr_common_init(struct device *dev,
 	if (!priv)
 		return -ENOMEM;
...
@@ -1075,7 +1074,7 @@ static int __init cpg_mssr_common_init(struct device *dev,
...
@@ -1095,7 +1094,7 @@ static int __init cpg_mssr_common_init(struct device *dev,
 	}
...
+		priv->pub.clks[i] = ERR_PTR(-ENOENT);
 	...
 	if (error)
@@ -1112,8 +1111,8 @@ static int __init cpg_mssr_common_init(struct device *dev,
 reserve_err:
