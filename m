Return-Path: <linux-renesas-soc+bounces-33779-lists+linux-renesas-soc=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-renesas-soc@lfdr.de
Received: from mail.lfdr.de
	by mail.lfdr.de with LMTP
	id NwoiD9lcKGoBCwMAu9opvQ
	(envelope-from <linux-renesas-soc+bounces-33779-lists+linux-renesas-soc=lfdr.de@vger.kernel.org>)
	for <lists+linux-renesas-soc@lfdr.de>; Tue, 09 Jun 2026 20:35:05 +0200
X-Original-To: lists+linux-renesas-soc@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [IPv6:2600:3c0a:e001:db::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id 83A0E6635B6
	for <lists+linux-renesas-soc@lfdr.de>; Tue, 09 Jun 2026 20:35:04 +0200 (CEST)
Authentication-Results: mail.lfdr.de;
	dkim=none;
	dmarc=none;
	spf=pass (mail.lfdr.de: domain of "linux-renesas-soc+bounces-33779-lists+linux-renesas-soc=lfdr.de@vger.kernel.org" designates 2600:3c0a:e001:db::12fc:5321 as permitted sender) smtp.mailfrom="linux-renesas-soc+bounces-33779-lists+linux-renesas-soc=lfdr.de@vger.kernel.org";
	arc=pass ("subspace.kernel.org:s=arc-20240116:i=1")
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id 2D6E930115B4
	for <lists+linux-renesas-soc@lfdr.de>; Tue,  9 Jun 2026 18:35:03 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id CF8983655F1;
	Tue,  9 Jun 2026 18:35:02 +0000 (UTC)
X-Original-To: linux-renesas-soc@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-alma10-1.taild15c8.ts.net [100.103.45.18])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 8475A3F1AA6
	for <linux-renesas-soc@vger.kernel.org>; Tue,  9 Jun 2026 18:35:01 +0000 (UTC)
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1781030102; cv=none; b=HHJmWlCAi33w4FOPT2h0S7b2+XmqxR5UZX/BncGnTQSV55ifA9e3GGGKv9Nxb2P7bumtSIPm1L0aGIqA8yY8R/ZMvMgQNW5bL+2DTuENJ0T9YD9OswrU1aJWwr2uRP1sVIHzTJBU1+nR2tatWh02QMtq+NdC9VBqKVOOGkUgwQU=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1781030102; c=relaxed/simple;
	bh=weG+WnATiwSboCSfZI5wuiceEFC+K+fQBeLW00p34ds=;
	h=From:To:Subject:Date:Message-ID:MIME-Version; b=nxmu+kUuWrAGfW0Hathi4AZEYCGJ7U5WRhL8SHB77Zh4eip9nlGNfGFz1wq57w0HgNnORedUsjYOWGUlFakntQ9TTUoQu96y2vG48Tl2h748EkI8wIBNpLZ7RRbos31lgT7lmyxJrYCe0uWy8zjTZK3XAuCOCnpgcXR8RxD+t6w=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; arc=none smtp.client-ip=100.103.45.18
Received: by smtp.kernel.org (Postfix) with ESMTPSA id B7CA81F00893
	for <linux-renesas-soc@vger.kernel.org>; Tue,  9 Jun 2026 18:35:00 +0000 (UTC)
From: Geert Uytterhoeven <geert+renesas@glider.be>
To: linux-renesas-soc@vger.kernel.org
Subject: renesas-drivers-2026-06-09-v7.1-rc7
Date: Tue,  9 Jun 2026 20:34:59 +0200
Message-ID: <20260609183459.262543-1-geert+renesas@glider.be>
...
X-Spamd-Result: default: False [-0.96 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	TAGGED_FROM(0.00)[bounces-33779-lists,linux-renesas-soc=lfdr.de,renesas];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[sea.lore.kernel.org:rdns,sea.lore.kernel.org:helo,vger.kernel.org:from_smtp,gitlab.freedesktop.org:url,linux-m68k.org:email]
X-Rspamd-Server: lfdr
X-Rspamd-Queue-Id: 83A0E6635B6

I have pushed renesas-drivers-2026-06-09-v7.1-rc7 to
...
Today's version is based on renesas-devel-2026-06-08-v7.1-rc7.
...
Included fixes:
  ...
  - Revert "pmdomain: core: switch to dynamic root device"
